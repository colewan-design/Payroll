  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-clock-rotate-left" style="padding-right:5px;"></i>Previous Payslips</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Previous Payslips</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card-box mb-30">
            <form>
                ...
                <td>
                  <select class="selectpicker" data-width="fit" id="xyz" onChange="window.location.href=this.value">
                    <option value=""disabled selected hidden>Actions</option>
                    <option class="btn-sm" target="_blank" value="history_mpdf.php?edit=<?php echo $row['emp_id']; ?>" data-content = "<i class='fas fa-eye pr-2' aria-hidden='true'></i>VIEW">VIEW</option>
                    <option  class="btn-sm"  value="payslip_download.php?edit=<?php echo $row['emp_id']; ?>" data-content = "<i class='fas fa-sharp fa-solid fa-download pr-2'></i>DOWNLOAD">DOWNLOAD</option>
						        <option  class="btn-sm"  value="process.php?payslipDelete=<?php echo $row['emp_id']; ?>" data-content="<i class='fas fa-sharp fa-solid fa-trash pr-2'></i>DELETE">DELETE</option>
                  </select>
                  <script>
                    window.onload = function(){
                      window.open(url,"_blank"); //open new tab on window.onload
                    }
                  </script>
                </td>
